const en = {
  ...
  navDatabaseAssistant: 'Database AI Assistant',
  ...
  demoStartOllamaCmd: 'ollama server',
  ...
  guidelineDbAssistantStep2Label: 'Ask a question',
  guidelineDbAssistantStep2Desc:
    'Type a question or pick a starter suggestion. The answer is generated by whichever provider is configured in Settings, and follow-up chips are suggested after each answer.',
  guidelineDbAssistantStep3Label: 'Check the Sources',
  guidelineDbAssistantStep3Desc:
    'When the question matches an excerpt from the official SQL Server, MySQL, PostgreSQL, or Oracle manuals, a Sources row appears under the answer naming which manual it drew from.',
  ...
  dbAssistantHeroBadge: 'Powered by your local AI',
  dbAssistantHeroTitle: 'Database AI',
  dbAssistantHeroTitleGradient: 'Assistant',
  dbAssistantHeroSubtitle:
    'Ask anything about SQL, schema design, indexing, or performance tuning — answered instantly by your configured AI model.',
  dbAssistantFeatureSql: 'SQL & Dialects',
  dbAssistantFeatureSchema: 'Schema Design',
  dbAssistantFeaturePerf: 'Performance Tuning',
  dbAssistantFeatureSecurity: 'Security & Backups',
  dbAssistantProviderLabel: 'Provider',
  dbAssistantModelLabel: 'Model',
  dbAssistantNewChat: 'New chat',
  dbAssistantPlaceholder: 'Ask about SQL, schemas, indexes, performance…',
  dbAssistantSend: 'Send',
  dbAssistantStop: 'Stop',
  dbAssistantThinking: 'Thinking…',
  dbAssistantRoleYou: 'You',
  dbAssistantRoleAssistant: 'Assistant',
  dbAssistantEmptyTitle: 'What do you want to know about databases?',
  dbAssistantEmptySubtitle: 'Pick a suggestion below or type your own question to get started.',
  dbAssistantSuggestionsLabel: 'Try asking',
  dbAssistantFollowUpsLabel: 'You might also ask',
  dbAssistantSourcesLabel: 'Sources',
  dbAssistantSuggestion1: 'How do I design a normalized schema for an e-commerce app?',
  dbAssistantSuggestion2: "What's the difference between a clustered and non-clustered index?",
  dbAssistantSuggestion3: 'How can I optimize a slow JOIN query?',
  dbAssistantSuggestion4: 'When should I use a NoSQL database instead of SQL?',
  dbAssistantSuggestion5: 'Explain ACID transactions in simple terms',
  dbAssistantSuggestion6: "What's the best way to paginate large result sets?",
  dbAssistantCopy: 'Copy',
  dbAssistantCopied: 'Copied!',
