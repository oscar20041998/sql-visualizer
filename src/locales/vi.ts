const vi = {
  ...
  noParamsToConfigure: 'Không có tham số để cấu hình',
  conditionalLabel: 'có điều kiện',
  ...
  complexityFactorsTotalScore: 'Tổng điểm',
  complexityFactorsMaximumScore: 'Điểm tối đa',
  complexityFactorsPercentageOfMaximum: 'Phần trăm điểm tối đa',
  complexityFactorsKeywordScoring: 'Điểm từ khóa',
  complexityFactorsSelectFields: 'Trường SELECT',
  complexityFactorsCount: 'Số lượng',
  complexityFactorsAverage: 'Trung bình',
  complexityFactorsScore: 'Điểm',
  complexityFactorsLintingIssues: 'Vấn đề linting',
  complexityFactorsNoLintingIssues: 'Không phát hiện vấn đề linting',
  complexityFactorsSuggestion: 'Đề xuất',
  complexityFactorsLocation: 'Vị trí',
  complexityFactorsFormula: 'Công thức yếu tố',
  ...
  complexityFactorsFieldTypeConditional: 'có điều kiện',
  complexityFactorsFieldTypeSubquery: 'truy vấn con',
  complexityFactorsFieldTypeAggregate: 'tổng hợp',
  complexityFactorsFieldTypeFunction: 'hàm',
  // Nested Subquery Analysis
  metricsNestedSubqueryAnalysisTitle: 'Phân tích Subquery Lồng nhau',
  metricsNestingDepthAnalysis: 'Phân tích Độ sâu Lồng nhau',
  metricsLevelDistribution: 'Phân phối Mức độ',
  metricsLevelLabel: 'Mức độ',
  metricsMaxStatus: 'Tối đa',
  ...
  metricsCopyButton: 'Sao chép',
  metricsAnalysisLabel: 'Phân tích',
  metricsComplexityRisk: 'Rủi ro Độ phức tạp',
  metricsBased: 'Dựa trên độ sâu & số lượng',
  metricsSubqueryRiskLimits: 'Ngưỡng rủi ro',
  metricsSubqueryRiskLowLimit: 'Độ sâu 0-1; số lượng 0-2',
  metricsSubqueryRiskMediumLimit: 'Độ sâu tối đa 2; số lượng tối đa 4',
  metricsSubqueryRiskHighLimit: 'Độ sâu tối đa 3; số lượng tối đa 6',
  metricsSubqueryRiskSuperHighLimit: 'Độ sâu 4+ hoặc số lượng 7+',
  ...
  highComplexityDetected:
    'Phát hiện độ phức tạp cao. Xem xét cấu trúc truy vấn và cân nhắc tối ưu hóa.',
  ...
  loading: 'Đang tải...',
  navigatingToPage: 'Đang chuyển trang...',
  success: 'Thành công',
  cancel: 'Hủy',
  confirm: 'Xác nhận',
  reset: 'Đặt lại',
  ...
  queryHistorySearchButton: 'Tìm kiếm',
  queryHistorySearching: 'Đang tìm kiếm…',
  queryHistoryClearSearch: 'Xóa tìm kiếm',
  queryHistorySemanticUnavailable:
    'Tìm kiếm theo ngữ nghĩa hiện không khả dụng (kiểm tra nhà cung cấp AI trong Cài đặt). Hiển thị kết quả khớp văn bản thay thế.',
  queryHistoryEmptyTitle: 'Chưa có truy vấn nào được lưu',
  queryHistoryEmptyHint: 'Chạy "Phân tích" trên một truy vấn và nó sẽ xuất hiện ở đây.',
  queryHistoryNoResults: 'Không có truy vấn nào khớp với tìm kiếm đó.',
  queryHistoryLoadButton: 'Tải',
  queryHistoryDeleteButton: 'Xóa',
  queryHistoryClearAllButton: 'Xóa tất cả',
  queryHistoryConfirmClearAll: 'Xóa tất cả truy vấn đã lưu?',
  queryHistoryConfirmYes: 'Có, xóa tất cả',
  queryHistoryConfirmCancel: 'Hủy',
  queryHistoryMatchLabel: 'khớp',
  queryHistoryEmbeddingPending: 'Chưa được lập chỉ mục để tìm kiếm ngữ nghĩa',
  queryHistoryTablesCount: '{n} bảng',
  queryHistoryJoinsCount: '{n} phép nối',
  queryHistorySavedToast: 'Đã lưu truy vấn vào lịch sử',
  ...
  homePreviewQueryTitle: 'Không gian truy vấn',
  homePreviewAnalyzed: 'ĐÃ PHÂN TÍCH',
  homePreviewInsightTitle: 'Tóm tắt phân tích',
  homePreviewComplexity: 'Điểm độ phức tạp',
  homePreviewRelationships: 'Quan hệ đã phát hiện',
  ...
  joinDetailSearchPlaceholder: 'Tìm kiếm bảng, cột, toán tử...',
  joinDetailNoResults: 'Không có kết nối nào phù hợp với tìm kiếm của bạn',
  joinDetailClearSearch: 'Xóa tìm kiếm',
