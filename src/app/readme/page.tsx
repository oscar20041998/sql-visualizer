  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-5xl px-6 py-12">
        <article
          className="prose prose-invert max-w-none [&_a]:text-primary [&_code]:text-primary [&_pre]:rounded-lg [&_pre]:border [&_pre]:border-border [&_pre]:bg-card"
