    ...
    <div className="mb-8 flex items-start justify-between">
      <div>
        <h1 className="text-2xl font-semibold text-foreground flex items-center gap-2">
          ...
          {t.queryInputTitle || 'Query Input'}
        </h1>
        <p className="text-sm text-muted-foreground mt-1">
          {t.queryInputSubtitle || 'Enter or analyze SQL queries'}
        </p>
      </div>
      {/* Dialect Selector */}
      <div className="relative">
        ...
        >
          <span className="text-muted-foreground text-xs">{t.dialectLabel || 'Dialect'}:</span>
          {currentDialect && (
            <AppImage
